-- Qualification Wav Premium multiréseaux.
-- Les nouvelles colonnes restent nullable pour préserver les candidatures
-- historiques. La policy INSERT exige leur présence uniquement sur les
-- nouvelles demandes envoyées par le formulaire public.
